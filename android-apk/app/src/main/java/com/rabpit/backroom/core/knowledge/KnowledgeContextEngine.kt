...
object KnowledgeContextEngine {
  ...
  private class Builder(
    ...
    private fun addDirectStructuredLookups() {
      ...
      if (hasAny(actionText, "lực lượng sru", "đơn vị sru", "đội sru", "special response unit", "lực lượng phản ứng đặc biệt", "cảnh sát chống hiện tượng dị thường", "sru năm 2299", "sru là gì")) direct += "WORLD.SRU.CORE"
