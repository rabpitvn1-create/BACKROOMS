...
SCRIPTS = [
    ...
    "patch-skill-description-vietnamese-finalize.py",
    "patch-skill-description-natural-vietnamese-finalize.py",
    "patch-skill-description-natural-test-compat.py",
    "patch-skill-description-ci-compat.py",
