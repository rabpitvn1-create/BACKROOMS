...
# Ordered final runtime transformation chain. Inventory V2 owns item state and mutations. The
# capacity scripts below are post-V2 presentation/regression guards only and cannot grant items.
PATCH_CHAIN = [
