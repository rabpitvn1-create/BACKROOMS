...
- Chỉ đặt snapshotEvent.shouldGenerate=true khi CHÍNH LƯỢT NÀY tạo ra một mốc hình ảnh mới, rõ ràng và đáng ghi lại: Kai bước vào một vùng đặc biệt khác biệt đáng kể của Level; một Entity lạ thực sự xuất hiện và được xác nhận; một sự kiện lớn/hiếm làm thay đổi rõ cảnh hiện tại; gặp nhân vật/survivor; hoặc chuyển Level.
- Phải đặt snapshotEvent.shouldGenerate=false cho đi lại/quan sát/tìm kiếm thông thường, hội thoại không đổi cảnh, hành động lặp lại, lượt yên, thay đổi nhỏ, nguy hiểm chỉ mới được nghi ngờ, hoặc khi cảnh nhìn tổng thể vẫn giống Snapshot hiện có.
- Khi phân vân, mặc định false. Không dùng số turn, thời gian kể từ ảnh trước hay mong muốn tạo kịch tính làm lý do tạo Snapshot.
...
JSON cần có dạng:
{
  ...
  "snapshotEvent": {
    ...
    "reason": "mô tả ngắn sự kiện hình ảnh; để trống nếu false"
  }
}
