...
- Canon/State -> điều kiện thực tế -> dice khi còn bất định -> hậu quả. Không bẻ canon, dice hoặc thế giới hồi tố để tạo kịch tính. UNKNOWN tiếp tục là UNKNOWN cho tới khi có bằng chứng hợp lệ.

CURRENT STATE
- Turn 9 đã hoàn tất.
- Kai đang ở Level 0 / The Lobby, khu phòng vàng gần vùng dị thường ba cột và cánh cửa trắng dị thường.
- Kai chưa bước qua cánh cửa trắng. Cửa nguyên bản đã mở ở Turn 8; phía sau là hành lang vàng, số đo độ sâu không gian biến thiên. Chưa xác nhận đây là Exit, portal, trap hay đường sang Level khác.
- Kai đã rời cửa một quãng ngắn để tìm nước nhưng giữ tuyến quay lại. Turn 9 tìm nước thất bại. Kai đang khát nhưng thể trạng ổn định, chưa có suy giảm thể chất mới.
- White Wraith Magnum đang DRAWN / READY.
- Không có survivor/NPC thông thường nào đã được Kai gặp hoặc xác nhận trong run hiện tại.
- Iris và Syvial tồn tại nhưng đang tách khỏi Kai. Vị trí và tình trạng của họ UNKNOWN TO KAI.
...
CONTINUITY
- Turn 2: Kai chọn tuyến phải; không survivor/hazard/Exit; tới junction mới.
- Turn 3: vào khe hẹp tối hơn; phát hiện ba vết xước song song trên cột.
- Turn 4: rút White Wraith Magnum; xuất hiện thêm vết xước nhưng cảm biến không xác nhận mục tiêu sinh học.
- Turn 5: vết xước xuất hiện không thấy tác nhân; layout phía sau thay đổi; cánh cửa trắng xuất hiện.
- Turn 6: cửa là vật thể vật lý; có dị thường độ sâu cục bộ phía sau.
- Turn 7: Omnivault Scan thành công. Slot 1 lưu PHYSICAL TEMPLATE của cánh cửa trắng; bản gốc bị MARKED; chưa có bằng chứng thuộc tính chuyển không gian được sao chép.
- Turn 8: cửa nguyên bản mở; phía sau là hành lang vàng với depth reading biến thiên; Kai không bước qua.
- Turn 9: tìm Almond Water thất bại; không uống chất lỏng không an toàn; không gặp survivor/Iris/Syvial; không hazard/Exit mới.

LEVEL 0
- Giấy dán tường vàng cũ, thảm ẩm, đèn huỳnh quang và tiếng ù liên tục; kiến trúc phi Euclid, layout có thể thay đổi.
...
- Nguy hiểm chính: mất nước, kiệt sức, mất phương hướng, tác động nhận thức.
...
- Không ép chuyển Level 1 vì đủ turn. Transition chỉ xảy ra khi môi trường thực sự đáp ứng continuity.
...
- Guilty Crown Override luôn đúng 24 phát đạn quỷ lực trong lúc thời gian ngoại giới dừng hoàn toàn.
- White Wraith Magnum dùng một loại đạn quỷ lực từ Sparda Core, không có ammo count thông thường; Single Shot và Full Auto xấp xỉ 600 viên/phút; tự sửa chữa bằng Core.
- Blackblood Armor, Demon Jaw Mask, Talon Gauntlets, Phantom Greaves còn nguyên và tự sửa chữa bằng Core.
- Omnivault: kho vật lý không giới hạn cho vật vô tri hợp lệ; Scan/Copy chỉ 3 slot; không tác động sinh vật sống. Slot 1 hiện giữ mẫu vật lý cửa trắng, Slot 2-3 trống. Bản gốc cửa đã Marked. Restore cooldown 24 giờ riêng cho từng vật sau một lần Restore thành công.
- Không nerf Kai để tạo khó giả.

ENCOUNTER FAIRNESS
- Survivor Encounter: đúng 2.00% mỗi gameplay turn đủ điều kiện, d10000 thành công 1-200.
- Iris Reunion: 0.0025% khi đủ điều kiện, d1000000 thành công 1-25.
- Syvial Reunion: 0.0025% khi đủ điều kiện, d1000000 thành công 1-25.
...
- Không dùng thoại cụt giả ngầu, ẩn dụ rỗng hoặc triết lý trang trí.
...
export function createCanonicalState(sessionId) {
  return {
    ...
    player: {
      ...
      codename: "Twilight",
      hp: null,
      condition: "Ổn định; đang khát",
      weapon: "White Wraith Magnum — DRAWN / READY",
    ...
    log: [
      ...
      { role: "gm", text: "Turn 6–7: cửa là vật thể vật lý có dị thường độ sâu phía sau. Omnivault Slot 1 đã quét mẫu vật lý của cửa; bản gốc bị Marked." },
      { role: "gm", text: "Turn 8: Kai mở cửa. Phía sau là hành lang vàng với số đo độ sâu không ổn định. Kai chưa bước qua ngưỡng." },
      { role: "gm", text: "Turn 9: Kai tìm nước quanh khu vực nhưng không tìm thấy nguồn uống an toàn. Hắn vẫn gần tuyến quay lại cánh cửa trắng, ổn định nhưng đang khát." }
    ],
